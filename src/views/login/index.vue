  ...
  <div id="login-container" class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">
          <img v-if="logo" :src="logo" class="sidebar-logo">EZ Monitor{{ $t('login.title') }}
        </h3>
      ...
      <div class="register">
        <b>还没有账户? <span @click="onGoto('/register')">注册新账户</span></b>
        <b><span @click="onGoto('/forget')">忘记密码?</span></b>
      </div>
    </el-form>
    ...
    <!--<remote-js src="js/ribbon.js"></remote-js>-->
  </div>
</template>
